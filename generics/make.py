...
subprocess.call('svn export --force -r 18526 ' + gslab_make_path + ' gslab_make', shell = True)
...
# RUN ALL TESTS
run_stata(program = 'test/test_input_param.do', changedir = True)
run_stata(program = 'test/test_comparables_regression.do', changedir = True)
