*********************************************************
* MIXLDERIV.ADO: Outputs derivative of choice probability w.r.t. mean utility.
* Based on mixlpred v 1.1.0 by Arne Risa Hole.
* Outputs expected value of P*(1-P) instead of expected value of P
* where P is choice probability.
*********************************************************

program define mixlderiv
	version 9.2
